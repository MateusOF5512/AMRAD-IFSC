    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div>
        <div className="flex items-center justify-between mb-3">
          ...
          {shapeType && <CheckCircle2 className="w-5 h-5 text-primary" />}
        </div>
      ...
      <div>
        <div className="flex items-center justify-between mb-3">
          <label className="block text-sm font-medium text-foreground">{t('experimentWizardNew.forms.sample.dimension')}</label>
          {shapeDimension > 0 && <CheckCircle2 className="w-5 h-5 text-primary" />}
        </div>
        <div>
          <FormFieldLabel
          ...
          <input
            ...
            className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary/40 focus:border-transparent transition-colors ${
              shapeDimension > 0 ? 'border-green-300 bg-primary-light' : 'border-border'
            }`}
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          {circleRoiArea > 0 && <CheckCircle2 className="w-5 h-5 text-primary" />}
        </div>
        <input
          type="number"
          step="0.01"
          ...
          className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-primary/40 focus:border-transparent transition-colors ${
            circleRoiArea > 0 ? 'border-green-300 bg-primary-light' : 'border-border'
          }`}
