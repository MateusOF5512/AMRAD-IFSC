  ...
  return (
    <footer className="bg-green-600 text-white mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/experimentos" className="text-green-50 hover:text-white transition-colors">
                  {t('footer.quickLinks.exploreExperiments')}
                </Link>
              </li>
              <li>
                <Link href="/meus-experimentos" className="text-green-50 hover:text-white transition-colors">
                  {t('footer.quickLinks.myExperiments')}
                </Link>
              </li>
              <li>
                <Link href="/novo-experimento" className="text-green-50 hover:text-white transition-colors">
                  {t('footer.quickLinks.newExperiment')}
                </Link>
              </li>
              <li>
                <Link href="/settings" className="text-green-50 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:suporte@ion3d.com" className="text-green-50 hover:text-white transition-colors">
        ...
        {/* Divider */}
        <div className="border-t border-green-500 my-8" />
